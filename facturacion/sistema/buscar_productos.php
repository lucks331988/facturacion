...
<body>
	...
	<section id="container">
        ...
        ?>
		<h1><i class="fa-solid fa-file-lines"></i> Lista de Productos</h1>
        <a href="registro_producto.php" class = "btn_new"><i class="fa-solid fa-cart-plus"></i> Agregar Producto</a>
        ...
        <table>
            ...
            <tr class="row<?php echo $data['codproducto'];?>">
                ...
                <td>
                    <a class="link_add add_product" product="<?php echo $data['codproducto'];?>" href="#"><i class="fa-solid fa-cart-plus"></i> Agregar</a>
                    |
